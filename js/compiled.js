...
var $author$project$App$intialModel = function (_v0) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$App$Increment)
							]))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$App$Decrement)
					]),
				_List_fromArray(
					[
...
var $author$project$App$main = $elm$browser$Browser$element(
	{
		init: $author$project$App$intialModel,
